...
<Navbar/>
  <div class="max-w-7xl mx-auto p-4 mt-8">
        ...
        <div class="my-4 space-y-4 border-2 border-white border-dashed bg-gray-700 p-5 rounded-xl">
          ...
          <div class="space-x-4 flex items-center justify-end">
            <a href="" class="inline-flex text-white text-sm">
              Cancelar
            </a>
        ...
        <div class="mt-4">
          <div class="space-y-8">
            <div>
              ...
              <div class="space-y-3">
                <div class="px-5 py-6 bg-gray-700 rounded-lg shadow">
